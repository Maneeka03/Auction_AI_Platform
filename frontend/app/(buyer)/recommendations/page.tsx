  ...
  return (
    <div className="group overflow-hidden rounded-xl border border-neutral-200 bg-white transition-shadow hover:shadow-md">
      <div className="relative h-44 w-full bg-white">
        ...
        <span className="absolute left-2 top-2 flex items-center gap-1 rounded-full bg-sky-500 px-2 py-0.5 text-xs font-semibold text-white shadow">
      ...
      <div className="px-4 pb-4">
        <button
          type="button"
          disabled
          className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-sky-500 py-2 text-sm font-semibold text-white cursor-not-allowed opacity-80"
        >
