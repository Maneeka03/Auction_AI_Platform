...
export function SortByDropdown({ value, onChange }: SortByDropdownProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen ? (
        <div
          className={`absolute right-0 z-30 mt-2 w-40 origin-top-left rounded-xl border border-neutral-200 bg-white p-1.5 shadow-lg transition-all duration-150 ease-out ${
